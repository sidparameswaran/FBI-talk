...
\path[->, very thick, orange] (s0.center) edge (t0.center);

\node[inv] (s1) at (0.1, -0.1){};
\node[inv] (t1) at (0.1,  0.1){};
\path[->,very thick, orange] (s1.center) edge (t1.center);

\node[inv] (s2) at (0.6, -0.1){};
\node[inv] (t2) at (0.6,  0.1){};
\path[<-,very thick, orange] (s2.center) edge (t2.center);

\node[inv] (s3) at (0.8, -0.1){};
\node[inv] (t3) at (0.8,  0.1){};
\path[->, very thick, orange] (s3.center) edge (t3.center);

\node[inv] (s4) at (1.3, -0.1){};
\node[inv] (t4) at (1.3,  0.1){};
\path[<-, very thick, orange] (s4.center) edge (t4.center);

\node[inv] (s5) at (1.5, -0.1){};
\node[inv] (t5) at (1.5,  0.1){};
\path[->, very thick, orange] (s5.center) edge (t5.center);

 \node[inv] (s6) at (2.0, -0.1){};
 \node[inv] (t6) at (2.0,  0.1){};
\path[<-, very thick, orange] (s6.center) edge (t6.center);

\node[inv] (s7) at (2.2, -0.1){};
\node[inv] (t7) at (2.2,  0.1){};
\path[<-, very thick, orange] (s7.center) edge (t7.center);
...
\draw[color=black, thick] (vm1.center)  -- (u0.center);
\draw[ color=black, thick] (v0.center)  -- (u1.center);
\draw[ color=black, thick] (v1.center)  -- (u2.center);
\draw[ color=black, thick] (v2.center)  -- (u3.center);
\draw[color=black, thick] (v3.center)  -- (u4.center);
