...
%    \begin{column}[T]{.5\textwidth}
  $$
    ...
    $$
    \only<1>{
    Inversion symmetries map left Schmidt states to  right Schmidt states with the same eigenvalue. Combined with the map that matches each Schmidt state on right to its partner on the left, you get an antiunitary action on sets of degenerate Schmidt states.
