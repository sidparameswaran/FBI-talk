...
plot_params = {'axes.labelsize': 14,   # 8
               ...
               'figure.figsize': (8, 6)}  # (3.5, 2.5) default
...
with PdfPages('L_10_all_mom_10.pdf') as pdf:
    for i in range(10, 11):
        ...
        fig, spec_ax = spec_points.plot_toolbox.spec_plot(spec_points, data_name,
                                                         shift_func=shift_func, copy_points=True)
        if i!=10 and i!=0:
            plt.title('Entanglement Spectrum for b=0.'+stri, fontsize=14)
        elif i==10:
            plt.title('Entanglement Spectrum for soft-core state', fontsize=14)
        elif i==0:
        ...
        ax.legend(handles2, labels3, loc = 5, fontsize=14, numpoints=1)
