...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{ShortDistanceCorrelations_L8.pdf}
	\vskip-5ex
	\caption{
	 Short distance correlation functions $\ev{b_0^{\dagger} b_x}$ (top panels)
	 and $\ev{(n_0-\frac12)(n_x-\frac12)}$ (bottom panels) 
	 for the soft-core HFBI (left panels) and the hard-core HFBI (right panels)
	 on the $W=8$ cylinder.
