...
\begin{figure}[hbtc]
	...
	\caption{
	 ...
	 \brayden{Larger system size coming soon}
	 }
	\label{fig:ShortCorr}
\end{figure} 
...
is bounded from above by $-1/\log |\lambda_1|$~\cite{schollwock2005}. In the following, we thus
...
\begin{figure}[hbtc]
	...
	\brayden{More data points and fit coming soon. The symmetric correlation eigenvalue has a phase for both hard-core and soft-core for $W \le 3$, resulting in oscillatory behavior for the density-density correlations.}}
	\label{fig:TMS}
\end{figure}
