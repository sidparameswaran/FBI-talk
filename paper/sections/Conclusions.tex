...
$h$ of the wavefunction that squares to the identity and that can be written as the product of an 
on-site symmetry $g$ and reflection of the 1D system about the center of a bond $\I_y$.
...
Since
$$
V_{\mathcal{\pi} \mathcal{I}} V_{\mathcal{\pi} \mathcal{I}}^* = -I \text{\quad or \quad } V_{\mathcal{\pi}} V_{\mathcal{I}_y} = - V_{\mathcal{I}_y} V_{\mathcal{\pi}},
$$
