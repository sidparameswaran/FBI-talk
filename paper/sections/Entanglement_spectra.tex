...
\begin{figure}[htbc]
  ...
  \vskip-3ex
  \caption{
  Fits of the form $a + \frac{b}{L} + \frac{c}{L^2}$ for the lowest five states above the ground state in Figure~\ref{fig:ESL910}. The constants in the fits are consistent with 0. The resulting
  $1/L$ scaling is a signature of a gapless (entanglement) Hamiltonian.}
  \label{fig:EEScaling}
\end{figure}
