...
\begin{figure}[htbc]
	\centering
	\includegraphics[width=2.5in]{{EntanglementSpectrum_L10.pdf}}
	\includegraphics[width=2.5in]{{EntanglementSpectrum_L9.pdf}}
	\caption{
    \bela{Remove figure titles and try to make them fit more naturally as two panels
    of one figure.}
    Entanglement spectrum on the zig-zag edge of a cylinder of
    circumference $W=10$ (top panel) and $W=9$ (bottom panel),
    as function of transverse momentum $K_y$. The legend indicates
    the boson number of the Schmidt state.}
	\label{fig:ESL910}
\end{figure}
...
\begin{figure}[htbc]
  ...
  \caption{ \bela{Remove figure title.}
  Power law fits for the lowest five states above the ground state in Figure \ref{fig:ESL10}. The
...
with $S_0 = 0$, thus making it unlikely that our state is topologically ordered.
