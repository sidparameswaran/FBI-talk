...
$Q = \sum_i \sigma_i - L/2$ that measures the fluctuation of charge across the cut. 
By convention, we subtract the $L/2$ so that the average charge fluctuation
satisfies $\ev{Q} = 0$.
...
as well as assign quantum numbers to both the Schmidt states and the entanglement
spectrum. 
...
1}$ can be found centered around momentum $K=\pi$. The states are shown identified in the 
spectrum. in Figure~\ref{fig:EEIdentifyPi}. Although the larger $m$ states are too high in energy 
