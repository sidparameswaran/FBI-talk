...
spin chain, where one can derive the relation $\eta = (-1)^m$ - that is, the spectrum consists of a combination of states from the periodic boson CFT with even $m$ and states from the anti-periodic boson CFT and odd $m$. The states are shown identified in the spectrum in Figure~\ref{fig:EEIdentify2}
