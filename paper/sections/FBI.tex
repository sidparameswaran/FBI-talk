...
site. In the case of soft-core bosons, the maximum number of bosons 
per site is 3.
...
W_{i_0 i_1}^{j}  = \left\{ \begin{array}{ll}
											...
											\right.,
\end{equation}
and where each index takes values in $\{0, 1\}$. Applying this to each 
...
circumference $L$.
In Fig.~\ref{fig:PEPS}, we have indicated the choice of boundary 
conditions for the cylinder. For many practical purposes, the PEPS on 
an infinite
cylinder can be represented as an infinite, translationally invariant 
matrix-product state of bond dimension $2^L$.
