...
% I don't think we need a picture of an MPS...
%\begin{figure}[H]
%	\centering
...
%	\caption{\bela{In this picture, we need to indicate the physical legs (maybe in a different color).} Pictoral representation of a PEPS on a honeycomb lattice. The tensors A and B are rank 4, with the physical leg at each site not shown for visual clarity.}
%	\label{fig:PEPS}
%\end{figure}
