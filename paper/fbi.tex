...
\usepackage{amssymb}
\usepackage{graphicx}
\graphicspath{{../images/}{../diagrams/}{.}} %what folders to look for images in
...
\input{sections/PEPS_construction}
\input{sections/Entanglement_spectra}
\input{sections/Edge_CFT_identification}
\input{sections/SPT_order}
