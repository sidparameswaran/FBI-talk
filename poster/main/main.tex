...
\begin{column}{\leftcolwid}
			\begin{center}	
			\vskip-20ex
			\includegraphics{ucsb.pdf}
      \end{center}	
      \vskip2ex
      \input{blocks/block1A}
      \vskip2ex
      \input{blocks/block1B}
       \vskip2ex
      \input{blocks/block1C}
      \vskip2ex
\end{column}
...
\begin{column}{\midcolwid}	
      \input{blocks/block2A}
      %\vskip2ex
      \input{blocks/block2B}
      \vskip2ex
      \input{blocks/block2C}
      \vskip2ex%
      \input{blocks/block2D}
      \vskip2ex%              
\end{column}
...
\begin{column}{\rightcolwid}
		  ...
		  \begin{center}	
      \vskip-15ex \includegraphics{Microsoft-Research.jpg}	
		  \end{center}
			\vskip5ex
      \input{blocks/block3A}
      \vskip2ex
      \input{blocks/block3B}
       \vskip2ex
      \input{blocks/block3C}
      \vskip2ex%
      \input{blocks/block3D}
      \vskip2ex%             
\end{column}
